document.addEventListener("DOMContentLoaded", function() {
    ...
    createButton.addEventListener("click", async function(){
        ...
        let baseUrl='http://localhost/levesek/index.php?levesek/'+megnevezes;
    ...
    readButton.addEventListener("click", async function(){
        let baseUrlEtelek="http://localhost/levesek/index.php?levesek";
        let optionsEtelek={
            method: "GET",
            mode: "cors"
        };
    ...
    function etelekListazasa(levesek){
        ...
        let tablazat = levesekFejlec();
        for(let leves of levesek){
            tablazat+= levesekSor(leves);
        }
        etelekDiv.innerHTML = tablazat+"</div></div>";
    }

    function levesekSor(levesek){
